 ...
 * - Fix: Freestyle 'Back' button safety guard (prevents data loss).
 * - Fix: Freestyle filter persistence (remembers category after set).
 * - Fix: Deload menu sync after editing 'Deload Only' plans.
 */
